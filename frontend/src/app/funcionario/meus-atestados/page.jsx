                    ...
                    {isLoading ? (
                        ...
                        <div className="divide-y divide-gray-100">
                            {atestados.map((atestado) => (
                                <div key={atestado.id} className="p-6 flex flex-col gap-3 hover:bg-gray-50 transition-colors">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        ...
                                        <div className="flex items-center md:justify-end">
                                            {atestado.fileUrl ? (
                                                <a href={atestado.fileUrl} target="_blank" rel="noreferrer"
                                                    className="flex items-center gap-2 text-sm text-white font-medium bg-[#00a8ac] hover:bg-[#008f92] px-4 py-2 rounded-md transition-colors">
                                    ...
                                    {/* Motivo de recusa visível para o funcionário */}
                                    {atestado.status === 'REJECTED' && atestado.motivoRecusa && (
                                        <div className="ml-14 bg-red-50 border border-red-100 rounded-lg px-4 py-3">
